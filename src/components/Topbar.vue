    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6">
      ...
      >
        ...
        <nav class="hidden space-x-10 md:flex">
          ...
          -->
            <div
              class="absolute z-10 -ml-4 mt-3 w-screen max-w-md px-2 sm:px-0 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2"
            >
              <div
              ...
              >
                ...
                <div
                  class="space-y-6 bg-gray-50 p-5 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8"
                >
                  <div class="flow-root">
                    <a
                      href="#"
          ...
          -->
            <div
              class="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 px-2 sm:px-0"
            >
              <div
                class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5"
              >
